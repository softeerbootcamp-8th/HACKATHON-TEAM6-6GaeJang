...
export function PotDetailSheet({ potId, onClose }: PotDetailSheetProps) {
  ...
  else if (isEnteringMenu)
    body = <MenuEntry detail={detail} onClose={() => setIsEnteringMenu(false)} />
  ...
  return (
    <div className="absolute inset-0 z-40">
      ...
      <div
        ref={sheetRef}
        className={`pot-detail-sheet-slide-up bg-bg absolute inset-x-0 top-[104px] bottom-0 flex flex-col rounded-t-[34px] pt-3 ${
  ...
  return (
    <div className="relative flex h-full flex-col">
      ...
      <form
        id="join-pot-form"
        onSubmit={submit}
        className="min-h-0 flex-1 overflow-y-auto px-5 pt-2 pb-28"
      >
        ...
        <label className="mt-10 block">
          ...
          <textarea
            ...
            placeholder="원하시는 메뉴와 옵션을 입력해주세요"
